...
object MatrixDecoder extends DecodeConstants {
  ...
  val mmul: Array[(BitPat, XSDecodeBase)] = Array(
    ...
    MMA_MM -> MMUL(MmulOpType.MMA),
    MMA_H_MM -> MMUL(MmulOpType.MMA_H),
    MMA_W_MM -> MMUL(MmulOpType.MMA_W),
    MMA_DW_MM -> MMUL(MmulOpType.MMA_DW),
    MWMA_MM -> MMUL(MmulOpType.MWMA),
    MWMA_H_MM -> MMUL(MmulOpType.MWMA_H),
    MWMA_W_MM -> MMUL(MmulOpType.MWMA_W),
    MQMA_MM -> MMUL(MmulOpType.MQMA),
    MQMA_B_MM -> MMUL(MmulOpType.MQMA_B),
    // MOMA_MM -> MMUL(MmulOpType.MOMA),
    // MOMA_HB_MM -> MMUL(MmulOpType.MOMA_HB),
